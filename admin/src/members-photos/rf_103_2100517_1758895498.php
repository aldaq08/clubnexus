...
<body>
    ...
    <main class="container">
        ...
        <section class="welcome-section">
            ...
            <div class="highlight">
                <p><strong>Please note:</strong> We are currently only accepting applications for <strong>new organizations</strong>. Renewal applications are not being processed at this time.</p>
            </div>
        </section>
        ...
        <section class="requirements-section">
            ...
            <div class="requirement-item">
                <h4>Attachments</h4>
                <ul class="sub-items">
                    <li><strong>A. Proposed Constitution & By-Laws:</strong> Submit a copy of the organization's proposed constitution and by-laws. This document should clearly define the organization's purpose, structure, membership, and operational guidelines.</li>
                    <li><strong>B. List of Officially Enrolled Founding Members:</strong> Provide a list of all founding members who are officially enrolled students at ISUFST-San Enrique Campus.</li>
                    <li><strong>C. List of Founding Officers and Faculty Adviser:</strong> Include a list of the organization's founding officers (e.g., President, Vice President, Secretary, Treasurer) and the name of the faculty member who has agreed to serve as the organization's adviser.</li>
                    <li><strong>D. Certificate of Official Enrollment from the Registrar:</strong> Obtain and submit a certificate of official enrollment from the Registrar for all founding members.</li>
                    <li><strong>E. Proposed Target Plan:</strong> Outline the organization's proposed activities, events, and goals for the academic year. This plan should be realistic and aligned with the organization's purpose.</li>
                    <li><strong>F. Security Clearance:</strong> Provide security clearance for all founding members.</li>
                    <li><strong>G. Written Authority from Religious Supervisor (if applicable):</strong> If the organization is religious in nature, provide written authority from the appropriate religious supervisor.</li>
                </ul>
                <a href="#" class="download-btn" download>
                    Download Requirements Form
                </a>
            </div>
        </section>
        ...
        <section class="contact-info">
            ...
            <div class="contact-details">
                <div class="contact-item location">
                    <span>ISUFST-San Enrique Campus, Student Support Center</span>
                </div>
                ...
                <div class="contact-item email">
                    <span>studentsupport@isufst.edu.ph</span>
                </div>
            </div>
        </section>
    ...
    <footer>
        <div class="container">
            <p>&copy; 2023 ISUFST Student Support Center. All rights reserved.</p>
        </div>
    </footer>
