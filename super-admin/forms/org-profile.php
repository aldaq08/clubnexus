<?php
include("../database/display_org.php");

// Define orgId early since it's used in multiple sections
...
<header>
  <?php if ($orgLogo): ?>
    <img class="logo" src="../../reg-user/src/org-logo/<?php echo $orgLogo; ?>" alt="<?php echo $orgName; ?> Logo" />
  <?php else: ?>
...
<div id="about-panel" role="tabpanel" aria-labelledby="about-tab" style="height: 100%; width: 75%;">
    ...
    $coverImage = !empty($orgCover) ? "../../reg-user/src/org-cover/" . htmlspecialchars($orgCover) : null;
    $logoImage = !empty($orgLogo) ? "../../reg-user/src/org-logo/" . htmlspecialchars($orgLogo) : "default-logo.png";
...
<div id="membership-panel" role="tabpanel" aria-labelledby="membership-tab" hidden>
    ...
    $logoUrl = !empty($orgLogo) ? "../../reg-user/src/org-logo/" . htmlspecialchars($orgLogo) : "default-logo.png";
    ?>
    <style>
        #membership-panel {
            min-width: 100%;
