...
<link rel="icon" type="image/c-favicon" href="src/clubnexusicon.ico">
...
<link href="https://fonts.googleapis.com/css2?family=Outfit:wght@100..900&display=swap" rel="stylesheet">
    <style>
        ...
        /* Add new styles for approval time display */
        .approval-time {
            font-size: 0.75rem;
            color: #666;
            margin-top: 4px;
        ...
        /* Update existing styles to accommodate approval time */
        .post-actions {
            display: flex;
            gap: 10px;
            align-items: center;
        ...
        .applicant-footer .status-container {
            display: flex;
            flex-direction: column;
            align-items: flex-start;
        }
...
<div class="tabcontent" id="Applicants">
    <?php
        ...
        $query = "SELECT a.announcement_id, a.org_id, a.user_id, a.announcement_title, a.announcement_text, 
                         a.announcement_file, a.announcement_approve, a.created_at, a.updated_at,
        ...
        function formatApprovalTime($updated_at, $status) {
            ...
            try {
                ...
                if ($status === 1) {
                    return "Approved on: " . $formatted_time;
                } elseif ($status === 0) {
                    return "Disapproved on: " . $formatted_time;
                } else {
                    return "Last updated: " . $formatted_time;
                }
            } catch (Exception $e) {
                return '';
            }
    ...
    <div class="container-flex" style="margin-top:10px;">
        ...
        <div class="stream" id="announcementStream" style="flex: 1;">
            <!-- Placeholder elements remain the same -->
            ...
            if (empty($announcements)) {
                ...
                foreach ($announcements as $announcement):
                    ...
                    $updated_at_raw = $announcement['updated_at'] ?? '';
                    ...
                    $approval_time = formatApprovalTime($updated_at_raw, $status);
                ...
                <div style="margin-top: 10px; display: flex; justify-content: space-between; align-items: center;">
                    <div class="status-container">
                        <?php if ($status === 1): ?>
                            ...
                            <?php if (!empty($approval_time)): ?>
                                <span class="approval-time"><?php echo $approval_time; ?></span>
                            <?php endif; ?>
                        <?php elseif ($status === 3): ?>
...
<div class="tabcontent" id="Achievements">
    <?php
        ...
        function formatAchievementApprovalTime($updated_at, $status) {
            if (empty($updated_at)) return '';
        ...
        <div class="stream" id="postStream" style="flex: 1;">
            ...
            if (empty($posts)) {
                ...
                foreach ($posts as $post):
                    ...
                    $updated_at_raw = $post['updated_at'] ?? '';
                    ...
                    $approval_time = formatAchievementApprovalTime($updated_at_raw, $achievement_approve);
...
<div class="tabcontent" id="Events">
    <?php
        ...
        // Update query to include updated_at
        $query = "SELECT e.event_id, e.approval_letter, e.event_name, e.event_description, 
                         ...
                         e.is_approve, e.updated_at, e.org_id, o.org_name, o.org_logo
                  FROM events e
        ...
        function formatEventApprovalTime($updated_at, $status) {
            if (empty($updated_at)) return '';
            ...
            try {
                ...
                if ($status === 1) {
                    ...
                    return "Denied on: " . $formatted_time;
                } else {
                    return "Last updated: " . $formatted_time;
                }
            } catch (Exception $e) {
        ...
        <div class="applicant-stream" id="eventStream" style="flex: 1; padding-left: 220px;">
            ...
            <?php else: ?>
                <?php foreach ($events as $event): 
                    ...
                    $updated_at_raw = $event['updated_at'] ?? '';
                    // ... other variables remain the same

                    $approval_time = formatEventApprovalTime($updated_at_raw, $status);
