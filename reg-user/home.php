...
<div class="head-content2">
                    ...
                    <aside id="sidebar" aria-label="Sidebar navigation" role="dialog" aria-modal="true" aria-hidden="true" tabindex="-1">
                        ...
                        <div class="categories">
                            <div class="category">
                            <button class="dropbtn"><b>ACCREDIT NOW? &nbsp;▼</b></button>
                            <div class="dropdown-content">
                                <a href="forms/accre-requirements.php">Make New Organization</a>
                            </div>
                            </div>
                        </div>
                        </div>  
                        ...
                        <div class="content-2">
                            ...
                            <div class="cont">
                                <button id="openCalendarBtn" class="calendar" title="Event Calendar" style="color: black;" onclick="window.location.href = 'event-calendar.php';" style="color: #0075A3"><b style="color: #0075A3">Events</b>
